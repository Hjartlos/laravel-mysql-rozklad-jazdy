...
return [
    ...
    'attributes'             => [
        ...
        'validity_hours' => 'ważność w godzinach',
    ],
    'custom'                 => [
        'email'       => [
        ...
        'line_number' => [
            'unique' => 'Numer linii w tym kierunku jest już zajęty.',
        ],
        'name'        => [
            'unique' => 'Nazwa jest już zajęta.',
        ],
        'stop_name'   => [
            'unique' => 'Przystanek o tej nazwie już istnieje.',
        ],
        'stops'       => [
            'required' => 'Lista przystanków jest wymagana.',
        ],
        'ticket_name' => [
            'unique' => 'Bilet o tej nazwie już istnieje.',
        ],
    ],
];
